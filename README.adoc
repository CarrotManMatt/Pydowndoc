...
image:{url-project-repo}/actions/workflows/check-build-publish.yaml/badge.svg[Tests Status,link={url-project-repo}/actions/workflows/check-build-publish.yaml]
